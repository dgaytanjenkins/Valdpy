...
class NordBordAPI:
    ...
    def __init__(self, tenant_id: str, header: Dict[str, str], region: str = 'USA'):
        ...
        if region == 'USA':
            self.url = 'https://prd-use-api-extnordbord.valdperformance.com'
        elif region == 'Australia':
            self.url = 'https://prd-aue-api-extnordbord.valdperformance.com'
        elif region == 'Europe':
            self.url = 'https://prd-euw-api-extnordbord.valdperformance.com'
        else:
